      ...
      <div className="mx-auto max-w-6xl">
        <div className="rounded-[2rem] border border-neutral-200 bg-white p-7 shadow-sm sm:p-10">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-7 text-neutral-600 sm:text-base">
            ...
            自社に近いものを一つ選び、そこから自由に変えていくことを想定しています。
          </p>
        ...
        <div className="mt-6 rounded-[2rem] border border-neutral-200 bg-white p-6 text-sm leading-7 text-neutral-600 shadow-sm sm:p-8">
          ...
          <p className="mt-2">
            どの見本から始めても、研究紹介、PDF、画像、YouTube、募集ポジションなどを自由に追加・削除できる設計にします。
            「最初の白紙をなくす」ための出発点です。
          </p>
          <div className="mt-5 flex flex-wrap gap-3">
            ...
            <Link href="/my/cpp/company" className="rounded-full border border-neutral-300 bg-white px-5 py-2.5 text-sm font-bold text-neutral-700">企業編集画面へ</Link>
          </div>
        </div>
      </div>
    </main>
