...
export default function UserProfilePage() {
    ...
    if (
      ...
      return (
        <PublicPage3QRenderer
          pattern={published3Q.pattern}
          design={published3Q.design}
          draft={published3Q.content}
          actions={published3Q.actions}
          images={published3Q.images}
        />
      );
    }
