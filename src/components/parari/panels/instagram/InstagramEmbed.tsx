      ...
      >
        {thumbnail ? (
          ...
          >
            ...
            <img
              src={thumbnail}
              alt={data.title.trim() || "Instagram投稿"}
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="block min-h-[140px] rounded-xl border border-dashed border-neutral-300 bg-neutral-50 px-4 py-10 text-center text-sm text-neutral-500"
          >
            サムネイルURLを入力してください。
            <br />
            Instagram投稿を開く
